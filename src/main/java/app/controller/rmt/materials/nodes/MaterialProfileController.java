...
public class MaterialProfileController implements Initializable {
    ...
    private void addListItems() {
        ...
        paramList.getItems().addAll(density, lorryTemp, materialTemp, brix, pressure, length,
                width, colorStage, headWeight, yield, variety, country, count, growerID, harvestDate, containerNo,
    ...
    private void relateCheckBoxToNode() {
        ...
        addParamNode(containerNo, new InformationNode("\"Container number will be required"));
    ...
    private void initializeCheckBoxes(MaterialSpecs specs) {
        ...
        if (specs != null) {
            ...
            if (specs.getContainerNo() == 1) {
                containerNo.selectedProperty().setValue(true);
            }
    ...
    private void btnActions() {
        ...
        // opens file
        openDocBtn.setOnAction(event -> FileUtil.openFile(documentPathField.getText()));
    ...
    private MaterialSpecs generateSpecs() {
        ...
        specs.setContainerNo(boolToInt(containerNo.isSelected()));
