...
public class DensityBox extends VBox {
    ...
    public void setDiameter(int diameter){
        diam1.setText(String.valueOf(diameter));
        diam2.setText(String.valueOf(diameter));
        diam3.setText(String.valueOf(diameter));
        diam4.setText(String.valueOf(diameter));
        diam5.setText(String.valueOf(diameter));
    }
    ...
    private void setGrossWeight(int weight){
