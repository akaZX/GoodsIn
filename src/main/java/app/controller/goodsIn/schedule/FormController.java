...
public class FormController implements Initializable {
    ...
    private void loadOrderDetails() {
        ...
        if (scheduleEntry != null) {
            ...
            poDetailsLabel.setText(
                    scheduleEntry.getSupplier().getSupplierName() + "  " + scheduleEntry.getOrder().getPoNumber());
...
//                System.out.println("updating order: " + getScheduleDetails().toString());
            ...
            msg.continueAlert(dPoint, LabelWithIcons.midWarningIconLabel("Failed to create/update entry"), new Label(
                    "Errors: " + errorMessage));
